...
public class FenetreParametre extends JFrame implements ActionListener {
	...
	private JComboBox algoGen; 
	private JComboBox algoRes; 
	...
	public FenetreParametre() {
		...
		String[] listeAlgoGen = { "Algo1", "Algo2", "Algo3", "Algo4", "Algo5" };
		algoGen = new JComboBox(listeAlgoGen);
		algoGen.setSelectedIndex(4);
		...
		String[] listeAlgoRes = { "Algo1", "Algo2", "Algo3", "Algo4", "Algo5" };
		algoRes = new JComboBox(listeAlgoRes);
		algoRes.setSelectedIndex(4);
